...
const sections = [
  ...
  },
  {
    ...
    body: [
      ...
      "The app may also read email metadata and message content needed to classify messages into triage buckets. Gmail access is intended to be read-only for this project.",
  ...
  },
  {
    ...
    body: [
      "Information is used to show your inbox, classify messages, summarize relevant threads, suggest actions, and organize results into action-focused buckets.",
  ...
  },
  {
    ...
    body: [
      "The app may store session information, saved agent context, and triage-related data needed for the product to function.",
